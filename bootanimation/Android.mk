...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	$(hide) tar xfp vendor/orion/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	cat vendor/orion/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
