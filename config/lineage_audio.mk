...
ALARM_PATH := vendor/orion/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/orion/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/orion/prebuilt/common/media/audio/ringtones
