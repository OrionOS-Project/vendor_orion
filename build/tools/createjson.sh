...
existingOTAjson=./orion/orion_ota/builds/$1.json
output=$2/$1.json
...
if [ "$4" = "true" ]; then
    ...
    echo "Generating JSON for OTA Vanilla Variant..."
    variant="A15_vanilla"
    existingOTAjson=./orion/orion_ota-vanilla/builds/$1.json
fi
